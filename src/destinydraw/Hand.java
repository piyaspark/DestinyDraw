...
public class Hand {
    ...
    public static String[] randomCard = new String[5]; // Random cards that give to player.

    public static String[] cardFilePlayer = new String[5];

    public static String[] cardFileDealer = new String[5];

    public static int[] cardValuePlayer = new int[5];
    public static int[] cardValueDealer = new int[5];
